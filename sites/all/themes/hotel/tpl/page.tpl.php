<div id="page" class="page-default"> <a id="Top"></a>
  ...
  <!-- /#SLIDESHOW -->
  <?php endif; ?>
  <?php if($slideshow_below = render($page['slideshow_below'])): ?>
  <!-- slideshow_below -->
  <div id="slideshow-below-wrapper" class="wrapper slideshow-wrapper">
    <div class="container <?php print $grid; ?>">
      <div class="grid-inner clearfix"> <?php print $slideshow_below ?> </div>
    </div>
  </div>
  <!-- /#slideshow_below -->
  <?php endif; ?>
